...
#define F2FS_MAX_LOG_SECTOR_SIZE	PG_SHIFT	/* Max is Block Size */
#define F2FS_LOG_SECTORS_PER_BLOCK	(PG_SHIFT - 9) /* log number for sector/blk */
#define F2FS_BLKSIZE			PG_SIZE /* support only block == page */
#define F2FS_BLKSIZE_BITS		PG_SHIFT /* bits for F2FS_BLKSIZE */
