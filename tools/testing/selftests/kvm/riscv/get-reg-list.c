...
bool filter_reg(__u64 reg)
{
	...
	case KVM_REG_RISCV_ISA_EXT | KVM_REG_RISCV_ISA_SINGLE | KVM_RISCV_ISA_EXT_SVNAPOT16K:
	case KVM_REG_RISCV_ISA_EXT | KVM_REG_RISCV_ISA_SINGLE | KVM_RISCV_ISA_EXT_SVNAPOT32K:
...
static const char *isa_ext_single_id_to_str(__u64 reg_off)
{
	static const char * const kvm_isa_ext_reg_name[] = {
		...
		KVM_ISA_EXT_ARR(SVNAPOT16K),
		KVM_ISA_EXT_ARR(SVNAPOT32K),
...
KVM_ISA_EXT_SIMPLE_CONFIG(svnapot16k, SVNAPOT16K);
KVM_ISA_EXT_SIMPLE_CONFIG(svnapot32k, SVNAPOT32K);
